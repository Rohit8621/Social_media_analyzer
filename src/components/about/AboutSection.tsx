...
const teamMembers = [
  {
    name: 'Harsh Bansal',
    // role: 'Lead Developer',
    description: 'Harsh specializes in building scalable applications with a focus on user experience and performance.',
    image: 'dist/assets/harsh.jpg' // Updated local image path
  },
  {
    name: 'Rohit Sharma',
    // role: 'AI Specialist',
    description: 'Rohit brings expertise in machine learning and natural language processing to our analytics platform.',
    image: 'dist/assets/rohit.jpg' // Updated local image path
  },
  {
    name: 'Sarthak Nimbalkar',
    // role: 'Data Scientist',
    description: 'Sarthak excels at transforming complex data into actionable insights for social media optimization.',
